...
def test_colqwen3_merged_checkpoint_strips_base_model_prefix_for_backbone():
    """merge_and_unload 后权重常为 base_model.model.visual / language_model 前缀，需能映射到模块真实子路径。"""
    assert (
        _apply_mapping(
            "base_model.model.visual.blocks.0.attn.qkv.weight",
            ColQwen3._checkpoint_conversion_mapping,
        )
