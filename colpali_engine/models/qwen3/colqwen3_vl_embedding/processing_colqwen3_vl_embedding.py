...
class ColQwen3VLEmbeddingProcessor(BaseVisualRetrieverProcessor, Qwen3VLProcessor):
    """
    Processor for ColQwen3VLEmbedding.
    ...
    def process_images(
        ...
        """
        Process images for ColQwen3VLEmbedding.
    ...
    def process_texts(self, texts: List[str]) -> Union[BatchFeature, BatchEncoding]:
        """
        Process texts for ColQwen3VLEmbedding.
